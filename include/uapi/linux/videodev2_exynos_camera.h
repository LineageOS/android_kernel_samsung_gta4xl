...
#define V4L2_CID_IS_S_NFD_DATA			(V4L2_CID_FIMC_IS_BASE + 76)
#define V4L2_CID_IS_S_FD_MODE			(V4L2_CID_FIMC_IS_BASE + 77)
...
#define V4L2_CID_IS_GET_REMOSAIC_CAL			(V4L2_CID_SENSOR_BASE + 131)
