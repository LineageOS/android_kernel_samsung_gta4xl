		...
		struct sec_battery_info *battery)
{
	...
	pr_info("%s: vendor : %s, technology : %d, cable_check_type : %d\n"
		...
		"polling_type : %d, initial_count : %d\n"
		"battery_check_type : %d, check_count : %d, check_adc_max : %d, check_adc_min : %d\n"
		...
		pdata->battery_check_type, pdata->check_count, pdata->check_adc_max, pdata->check_adc_min,
