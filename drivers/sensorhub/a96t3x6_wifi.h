...
#ifndef __LINUX_A96T3X6_WIFI_H
#define __LINUX_A96T3X6_WIFI_H
...
#define GRIP_INFO(fmt, ...) pr_info("[GRIP_WIFI] %s: "fmt, __func__, ##__VA_ARGS__)
#define GRIP_WARN(fmt, ...) pr_warn("[GRIP_WIFI] %s: "fmt, __func__, ##__VA_ARGS__)
