...
#include "hx83102e_gta4xl_param.h"
#include "dd.h"
...
static int hx83102e_init(struct lcd_info *lcd)
{
	...
	DSI_WRITE(SEQ_HX83102E_BL_PAD, ARRAY_SIZE(SEQ_HX83102E_BL_PAD));
	...
	DSI_WRITE(SEQ_SET_BD_BANK00, ARRAY_SIZE(SEQ_SET_BD_BANK00));
	DSI_WRITE(SEQ_SET_HX83102E_CABC_ON, ARRAY_SIZE(SEQ_SET_HX83102E_CABC_ON));
	...
	DSI_WRITE(SEQ_SET_BD_BANK00, ARRAY_SIZE(SEQ_SET_BD_BANK00));
	DSI_WRITE(SEQ_SET_E1_BANK00, ARRAY_SIZE(SEQ_SET_E1_BANK00));
	...
	struct device_attribute *attr, const char *buf, size_t size)
{
	...
	if (value == 1) {
		...
		DSI_WRITE(SEQ_SET_B9_PW, ARRAY_SIZE(SEQ_SET_B9_PW));
		DSI_WRITE(SEQ_SET_HX83102E_CABC_OFF, ARRAY_SIZE(SEQ_SET_HX83102E_CABC_OFF));
		DSI_WRITE(SEQ_SET_B9_CLOSE_PW, ARRAY_SIZE(SEQ_SET_B9_CLOSE_PW));
	}
