...
#define DPUI_MODEL_NAME		"AMS646UJ09"
#endif
...
static int ea8076_init(struct lcd_info *lcd)
{
	...
	DSI_WRITE(SEQ_SAP_08_1, ARRAY_SIZE(SEQ_SAP_08_1));
	DSI_WRITE(SEQ_SAP_08_2, ARRAY_SIZE(SEQ_SAP_08_2));

	DSI_WRITE(SEQ_ACL_SETTING_1, ARRAY_SIZE(SEQ_ACL_SETTING_1));
	DSI_WRITE(SEQ_ACL_SETTING_2, ARRAY_SIZE(SEQ_ACL_SETTING_2));
	DSI_WRITE(SEQ_ACL_SETTING_3, ARRAY_SIZE(SEQ_ACL_SETTING_3));
	DSI_WRITE(SEQ_ACL_SETTING_4, ARRAY_SIZE(SEQ_ACL_SETTING_4));
