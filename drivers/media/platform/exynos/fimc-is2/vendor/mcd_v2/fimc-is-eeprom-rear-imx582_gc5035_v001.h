...
#define DUAL_CAL_MODEL_ID_LEN        (0x1C3F - 0x1C2C + 0x1)
...
struct rom_dual_tilt_cal_data rear_imx582_dual_cal_info = {
	.rom_dual_tilt_dll_modelID_addr            = 0x1C2C,
	.rom_dual_tilt_dll_modelID_size            = DUAL_CAL_MODEL_ID_LEN,
};

struct rom_extend_cal_addr rear_imx582_extend_cal_addr_2 = {
	.name = EXTEND_DUAL_CAL,
	.data = &rear_imx582_dual_cal_info,
	.next = NULL,
};
...
const struct rom_extend_cal_addr rear_imx582_extend_cal_addr = {
	...
	.next = &rear_imx582_extend_cal_addr_2,
};
...
const struct fimc_is_vender_rom_addr rear_imx582_cal_addr = {
	...
	.extend_cal_addr                           = &rear_imx582_extend_cal_addr,
};
