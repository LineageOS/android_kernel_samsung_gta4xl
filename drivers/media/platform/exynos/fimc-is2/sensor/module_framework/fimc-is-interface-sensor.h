...
struct fimc_is_cis_ext_interface_ops {
	...
	int (*set_sensor_stat_control_per_frame)(struct fimc_is_sensor_interface *itf,
			enum fimc_is_sensor_stat_control stat_control_type,
			void *stat_control);
#ifdef USE_3HDR_CAMERA_INTERFACE
	int (*set_sensor_lsc_table_init)(struct fimc_is_sensor_interface *itf,
			enum fimc_is_sensor_stat_control stat_control_type,
			void *lsc_table);
	int (*set_sensor_tone_control)(struct fimc_is_sensor_interface *itf,
			enum fimc_is_sensor_stat_control stat_control_type,
			void *tone_control);
	int (*set_sensor_ev_control)(struct fimc_is_sensor_interface *itf,
			enum fimc_is_sensor_stat_control stat_control_type,
			void *ev_control);
#endif
};
